module.exports = {
  sidebar: [
  {
    ...
    items: [
      ...
      {
        "type": "category",
        "label": "What's Newsletter",
        "items": [
          {
            label: "2022"
            type: 'autogenerated',
            dirName: "whats-news/2022", // Source folder to generate the sidebar slice from (relative to docs)
          },
          {
            label: "2021"
            type: 'autogenerated',
            dirName: "whats-news/2021", // Source folder to generate the sidebar slice from (relative to docs)
          },
        ]
      },
   ],
