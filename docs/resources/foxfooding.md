...
This guide explains how to set up and participate in foxfooding, which allows Mozillians to test experimental features using preview rollouts and Nimbus Dev Tools.
