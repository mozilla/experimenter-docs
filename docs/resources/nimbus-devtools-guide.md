...
This guide provides an overview of the Nimbus Developer Tools, designed for debugging Nimbus experiments. With these tools, you can test experiments, debug targeting expressions, and browse through available experiments.
...
## Experiment Enrollment via JSON Recipe
...
## Experiment Enrollment via Feature Configuration
...
## Choosing Experiment Collection
