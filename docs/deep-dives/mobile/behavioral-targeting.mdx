...
|:---|:---|:---|
| Core Active Users | A user who has used the application 21 out of the last 28 days. | <pre><code>'<event\>'&#124;eventCountNonZero('Days', 28, 0) >= 21</code></pre> |
| Recently Logged In Users | A user who has logged into Sync within the last 12 weeks. | <pre><code>'<event\>'&#124;eventCountNonZero('Weeks', 12, 0) > 0</code></pre> |
