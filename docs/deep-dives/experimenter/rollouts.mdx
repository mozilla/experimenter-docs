...
The population percent ("Percentage of clients") on the Audience page of a rollout can be edited once a rollout is launched. To make changes to this field, open your rollout, and from the left sidebar click on the Audience page. From there, you will be able to make edits and save. Once an edit has been made, you will see a "Request update" button on the summary page under the available Actions:
...
Multiple edits can be made to your rollout without needing to request an update, and you will be able to see if there are unpublished changes by the red "Unpublished changes" status pill that is located by "Timeline":
   ...
   <img title="Unpublished changes status pill" src="/img/deep-dives/unpublished-changes-pill.png"/>
...
- [Live editability for rollouts](https://mozilla-hub.atlassian.net/browse/EXP-2561)
