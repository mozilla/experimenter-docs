...
If you are a mobile engineer, see the [Mobile FAQ](/faq/mobile) for how to add a version. To find how the version numbers work for your platform check the [versioning documentation](https://searchfox.org/mozilla-central/source/mobile/android/docs/shared/versioning.md).
