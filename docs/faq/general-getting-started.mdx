...
slug: /faq/general-getting-started
---
...
### Answer
[Jetstream](/data-analysis/jetstream/overview) is the whole **analysis system** (interfaces with data, runs analysis, formats results).
...
### Question
How long does it take to see Nimbus changes on the client (for time sensitive QA or hotfixes especially)?
