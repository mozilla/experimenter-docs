...
slug: /messaging/desktop/mobile-messaging
sidebar_position: 7
---

This article provides a comprehensive guide to the mobile messaging system in Firefox for iOS and Android, covering message configuration, localization, experimentation, and extending the system with custom triggers and actions.
...
[fenix-actions-fml]:             https://github.com/mozilla-mobile/firefox-android/blob/main/fenix/app/nimbus.fml.yaml#L23
[fenix-actions-eng]:             https://github.com/mozilla-mobile/firefox-android/blob/main/fenix/app/src/main/AndroidManifest.xml#L91-L126
...
The app provides the messaging system with [attributes](#list-of-attributes). We use JEXL expressions to query these attributes, or trigger messages based on [the user's behavior in the app](/advanced/behavioral-targeting).
...
[fenix-strings]: https://github.com/mozilla-mobile/firefox-android/blob/main/fenix/app/src/main/res/values/strings.xml
