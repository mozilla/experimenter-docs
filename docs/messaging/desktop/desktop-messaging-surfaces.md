...
title: Surfaces
slug: /messaging/desktop/desktop-messaging-surfaces
sidebar_position: 5
---

This article describes the different messaging surfaces available in Firefox Desktop that allow you to create and deploy messages remotely without shipping code changes.
