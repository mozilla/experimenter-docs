...
This article explains how messaging experiments and remote message deployments work together in Firefox, including how multiple messages can coexist when deployed through different channels.

## Experiments and Messaging Surfaces
...
## Remote Settings and Multiple Messages
