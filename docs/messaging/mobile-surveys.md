...
Targeting for surveys is either done through Nimbus or through the [messaging system](/messaging/desktop/mobile-messaging#triggers). Note that if custom targeting must be implemented, it should be done now and prior to the sizing calculations.
