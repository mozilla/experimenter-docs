...
This article describes the architecture and key components of the Nimbus experimentation system. It covers experiment configuration, client-side SDK operations, telemetry, and automated analysis systems.
...
### Automated Analysis System (Jetstream)
...
### Custom Configuration (Jetstream Configuration Files)  
