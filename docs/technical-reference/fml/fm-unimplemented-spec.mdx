...
title: FML History
slug: /technical-reference/fml/fm-unimplemented-spec
sidebar_position: 7
---

This document contains historical proposals and unimplemented specifications for the Feature Manifest Language that may be implemented in the future.
