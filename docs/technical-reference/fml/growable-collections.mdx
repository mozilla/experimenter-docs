...
title: Growable Collections
slug: /technical-reference/fml/growable-collections
---

Growable collections allow you to configure collections of items that can expand through experiments and rollouts without requiring code changes or app releases.
