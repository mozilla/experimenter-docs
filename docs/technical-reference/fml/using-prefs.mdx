...
id: using-prefs
title: Prefs
slug: /technical-reference/fml/using-prefs
sidebar_position: 6
---

This document explains how to use preference keys in feature definitions to allow user preferences to override Nimbus configuration values.
...
## Adding a Pref-Key to Feature Variable Definitions
