...
id: fml-imports
title: Imports
slug: /technical-reference/fml/fml-imports
sidebar_position: 3
---

This document explains how to compose feature manifests using imports and includes, enabling features to be defined close to their code while maintaining a complete picture for Experimenter.
...
include:
    - nimbus/search.yaml
    - @mozilla/nimbus-shared/technical-reference/fml/messaging.yaml
```
