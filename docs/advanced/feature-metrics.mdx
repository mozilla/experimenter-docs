...
slug: /advanced/feature-metrics
---

This article explains the process for adding custom metrics to your experiment when standard outcomes don't cover your needs.

## What to Do When Feature Metrics Aren't Available
...
Check  [here](/data-analysis/jetstream/metrics#how-do-i-add-a-metric-to-my-experiment) to learn if the existing Guardrail/Core metrics or Outcomes will answer your questions.

## Step 2: Reuse Metrics From Previous Experiments

Did an experiment run previously had these metrics you need?
...
Provide information to create a custom metric for this experiment.
