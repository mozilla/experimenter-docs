...
title: Feature API
slug: /advanced/feature-variables
---
...
**This document is still useful for the concepts. The [Feature Manifest Language specification](/technical-reference/fml/fml-spec) would be the best place for engineers to go having read this document.**
...
As always, there will be an exception to the rule. In the case of feature enrollment, there is a way to allow **certain features** to be co-enrolled. [This document](/technical-reference/fml/coenrolling-features) will give you more information about defining co-enrolling features and which features are currently instrumented to be co-enrollable.
...
**The [Feature Manifest Language specification](/technical-reference/fml/fml-spec) would be the best place for engineers to go having read this document.**
