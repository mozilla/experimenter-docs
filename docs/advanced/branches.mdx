...
title: Branches
slug: /advanced/branches
---

The Branches page provides different validation experiences for mobile and desktop experiments, including Feature Manifest Language errors for mobile and JSON linting with autocomplete for desktop.

## Feature Manifest Language Errors (Mobile Only)

:::tip
Want more info on the Feature Manifest Language?
Check out the documentation [here](/technical-reference/fml/fml-spec)
:::
