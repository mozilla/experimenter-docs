...
Hi ______,
I am requesting VP Sign-off for <replace with Experiment Name> (link <insert a link to your Experimenter study> and <link to experiment brief>) because:
...
- <Note: If there is a previous version of this study that had VP approved risk, please add "Risk approved in a previous version of this study here <linking to that experimenter study>".   If there is a combo of previously approved risks and new risks (from study changes), please mark the new risks as "New".
