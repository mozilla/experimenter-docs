...
This guide explains how to debug targeting expressions in Desktop Firefox using ASRouter devtools. You'll learn how to enable the tools, write and evaluate JEXL expressions, and use built-in functions for targeting.
...
## Built-in Functions and Examples
