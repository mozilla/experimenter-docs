...
Read more to find out if you want to send an [exposure event](/data-analysis/jetstream/overview#enrollment-vs-exposure). This is optional but a decision must be recorded in the manifest.
...
See the [API reference docs](/platform-guides/desktop/feature-api#api-reference-guide) for more details, including listening to changes.

## Step 3: Run tests

If you've configured fallback preferences your tests should pass as written, but we recommend also reading [Testing Guide](/platform-guides/desktop/testing) to add experiment-specific tests.
