...
This guide explains how to test Nimbus feature integrations in Desktop Firefox. You'll learn how to use ExperimentFakes helpers for automated testing, test with live recipes, and work with rollouts and gTest.
