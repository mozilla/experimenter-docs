...
The `nimbus-cli` is a command line tool for interacting with the Nimbus SDK embedded in Mozilla's mobile applications. It provides a uniform way of interacting with an app, no matter what the app or the platform.
