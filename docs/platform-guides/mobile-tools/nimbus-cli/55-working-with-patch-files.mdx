...
This guide explains how to use patch files to modify feature configurations before enrolling in experiments. Patch files allow you to change experiment configurations without editing the original experiment definitions.
