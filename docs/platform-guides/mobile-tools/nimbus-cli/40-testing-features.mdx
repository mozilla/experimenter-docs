...
This guide shows how to test features without using Experimenter and how to extract feature configurations from experiments. You can perform exploratory testing by specifying feature configurations directly via JSON files.
...
## Extracting Feature Configurations
