...
This guide covers the microsurvey feature, an extension of the messaging framework that enables targeting small surveys directly in the app to capture user sentiment on specific features.
