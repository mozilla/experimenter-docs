...
This guide covers the onboarding feature, which enables experimentation with the new user onboarding flow through customizable cards that help users configure app settings.
