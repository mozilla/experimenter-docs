...
This quarter brings major mobile improvements including Android notifications, iOS startup simplification, first-run testing tools, and the nimbus-cli. Desktop gains localization support, while Experimenter adds multifeature experiments, improved rollout support, and an Outreachy history tracker project.
