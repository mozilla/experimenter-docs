...
🛠️ Audience overlap
   ...
   > We now have warnings on Experimenter for three known cases of audience overlap. [These warnings](/advanced/experimenter-warnings) will prevent detectable cases of audience overlap, which generally result in under enrollment and can invalidate an experiment. (erichards) [EXP-4180](https://mozilla-hub.atlassian.net/browse/EXP-4180)
