...
This edition introduces the first Nimbus "What's New" newsletter, highlighting new features including the Nimbus directory, data visualizations, improved error messaging, and documentation linking capabilities.

## New Features

Welcome to our very first edition of our "What's New" newsletter. As our customers, we want to make sure we keep you in the loop with new Nimbus features and capabilities on a monthly basis.
