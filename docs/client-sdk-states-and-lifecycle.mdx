...
TODO:
* figure and deal with:
  * mozilla confidential
    * (ignore)
  * what happens to "Nimbus Experiment Publish Lifecycle" adjunct

  * remaining comments / feedback requests
    * quote and request feedback on github
  * intro paragraph
    * ask reviewer
* read
